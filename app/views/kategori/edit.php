            ...
            <form action="<?= BASEURL ?>/kategori/editData" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kat_nama" class="form-control" id="exampleInputEmail1" value="<?= $rowKategori['kat_nama'] ?>" aria-describedby="emailHelp" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail2" class="form-label">Description</label>
                        <textarea name="kat_keterangan" class="form-control" id="exampleInputEmail2" rows="3" required><?= $rowKategori['kat_keterangan'] ?></textarea>
                    </div>
                </div>
