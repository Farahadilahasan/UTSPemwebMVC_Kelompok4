    ...
    <div class="row d-flex align-items-center mt-4">
        ...
        <div class="col-1">
            <button type="button" class="btn btn-primary btn-sm tombolTambah" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5v14m0 -14h14m-14 0l14 14m-14 -14h14m-18 0l-6 6m0 -6l6 6" /></svg>
                Add Category
            </button>
        </div>
        <div class="col-2">
            <form action="<?= BASEURL ?>/kategori/searching" method="post">
                <div class="input-group">
                    <input type="text" name="cari_nama" class="form-control" placeholder="Search Name" aria-label="Recipient's username" aria-describedby="button-addon2">
                ...
                <tbody class="table-group-divider">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= BASEURL ?>/kategori/edit/<?= $rowKategori['kat_ID'] ?>" class="btn btn-warning btn-sm tombolEdit" data-bs-toggle="modal" data-bs-target="#exampleModal" data-kat_ID="<?= $rowKategori['kat_ID'] ?>">
                                ...
                                <a href="<?= BASEURL ?>/kategori/deleteData/<?= $rowKategori['kat_ID'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this data?');">
