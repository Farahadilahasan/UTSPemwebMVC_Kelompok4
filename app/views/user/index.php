        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?= $row['user_hp'] ?></td>
                        <td>
                            <a href="<?= BASEURL ?>/user/edit/<?= $row['user_id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="<?= BASEURL ?>/user/deleteData/<?= $row['user_id'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
            <?php
            }
